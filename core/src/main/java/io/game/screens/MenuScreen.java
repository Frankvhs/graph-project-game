...
public class MenuScreen implements Screen {
    ...
    private Stage stage;          // Stage de Scene2D
    ...
    private void cargarBotones() {
        ...
        float buttonWidth = screenW * 0.20f;  // 20% del ancho de la pantalla
        float buttonHeight = screenH * 0.12f; // 12% del alto de la pantalla
